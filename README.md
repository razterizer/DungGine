...
[![Build Check](https://github.com/razterizer/DungGine/actions/workflows/main.yml/badge.svg)](https://github.com/razterizer/DungGine/actions/workflows/main.yml)
...
if (game_over)
  set_state_game_over();
dungeon_engine->draw(sh, get_real_time_s(), get_sim_time_s(), anim_ctr, ui::VerticalAlignment::BOTTOM, ui::HorizontalAlignment::CENTER, -5, 0);
sh.print_screen_buffer(t, bg_color);
anim_ctr++;
```
